...
export default function App() {
  return (
    <>
        ...
        <button className="border p-2 text-3xl rounded-2xl font-(family name: vernon adams) shadow-[0_0_50px_-12px_rgba(168,85,0,3)] hover:shadow-[0_0_50px_-12px_rgba(168,8,0,3)] hover:scale-95 active:scale-75 hover:bg-gray-600 text-white transition-all duration-200">Let's Begin</button>
